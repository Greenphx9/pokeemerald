...
const u8 gPCText_Wallpaper1[] = _("WALLPAPERS 1");
const u8 gPCText_Wallpaper2[] = _("WALLPAPERS 2");
const u8 gPCText_Wallpaper3[] = _("WALLPAPERS 3");
const u8 gPCText_Wallpaper4[] = _("WALLPAPERS 4");
const u8 gPCText_Wallpaper5[] = _("WALLPAPERS 5");
...
const u8 gPCText_Checks[] = _("CHECKS");
const u8 gPCText_Pokecenter[] = _("POKéCENTER");
const u8 gPCText_Machine[] = _("MACHINE");
const u8 gPCText_Simple[] = _("SIMPLE");
const u8 gPCText_Nostalgia1[] = _("NOSTALGIA 1");
const u8 gPCText_Nostalgia2[] = _("NOSTALGIA 2");
const u8 gPCText_Space[] = _("SPACE");
const u8 gPCText_Backyard[] = _("BACKYARD");
const u8 gPCText_Torchic[] = _("TORCHIC");
const u8 gPCText_SinnohStarters[] = _("SINNOH STARTERS");
const u8 gPCText_PikaPika[] = _("PIKAPIKA");
const u8 gPCText_TimeSpace[] = _("TIME & SPACE");
